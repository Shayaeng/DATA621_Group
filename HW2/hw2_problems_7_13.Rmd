...
In the above code we initialized a function that calculates the TN and FP of the given dataframe and uses that to return the specificity. Now let's run the fuction on our data.
